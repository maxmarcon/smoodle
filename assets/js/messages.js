...
export default {
	...
	de: {
		...
		event_viewer: {
			...
			event_open: "{calendar_icon} Der Organisator hat noch kein Datum festgelegt. Hier unten sind die möglichen Daten, basierend auf den Antworten von {participants} Gästen. Gib deine Verfügbarkeit an, falls du es noch nicht getan hast.",
