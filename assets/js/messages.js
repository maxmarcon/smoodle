...
export default {
  en: {
    ...
    poll_editor: {
      welcome: "Here you can update your availability for ths event. Your participant name is: \u201C{participant}\u201E",
      welcome_new_participant: "Here you can enter your availability for this event.",
      title: "My availability for \u201C{eventName}\u201E",
      ...
      save_poll: "Save availability",
      delete_poll: "Delete your availability",
      poll_saved: "Your availability has been saved",
      really_delete: "Do you really want to delete your availability? This operation can't be undone",
      back_to_event: "Back to the event",
      poll_deleted: "Your availability has been deleted",
      poll_delete_error: "An error has occurred, the availability could not be deleted",
    ...
    event_viewer: {
      ...
      create_poll: "Enter your availability",
      update_poll: "Update your availability",
      cancel_event: "Cancel event",
      no_participants: "{icon} The event has not been scheduled and nobody entered their availability yet. Be the first one to answer!",
      no_participants_organizer: "{icon} The event has not been scheduled and nobody entered their availability yet.",
      ...
      date_selection_help: "Dates are ranked from {best} to {worst}. Click or hover on a date to see how many can make it on that day. {red} means that at least one person can't make it. {green} means that everyone can make it. {blue_underlined} dates are the optimal ones so far.",
      date_selection_help_organizer: "Dates are ranked from {best} to {worst}. Click or hover on a date to see who can make it on that day. {red} means that at least one person can't make it. {green} means that everyone can make it. {blue_underlined} dates are the optimal ones so far.",
      best: "best",
      worst: "worst",
      red: "Red",
      green: "Green",
      blue_underlined: "Blue underlined",
  ...
  de: {
    ...
    event_viewer: {
      ...
      date_selection_help: "Die Daten sind von {best} bis {worst} gekennzeichnet. Klicke ein Datum an, um zu erfahren, wie viele Leute an dem Tag kommen können. {red} bedeutet, dass mindestens eine Person nicht kommen kann. {green} bedeutet, dass alle Leute kommen können. {blue_underlined} Daten sind die bisher Besten.",
      date_selection_help_organizer: "Daten sind von {best} zu {worst} bewertet. Klick ein Datum an, um zu erfahren, wer an dem Tag kommen kann. {red} bedeutet, dass mindestens eine Person nicht kommen kann. {green} bedeutet, dass alle kommen können. {blue_underlined} Daten sind die bisher Besten.",
      best: "gut",
      worst: "schlecht",
      red: "Rot",
      green: "Grün",
      blue_underlined: "Blau unterstrichene",
  ...
  it: {
    ...
    event_viewer: {
      ...
      red: "Rosso",
      green: "verde",
      blue_underlined: "sottolineate in blu",
